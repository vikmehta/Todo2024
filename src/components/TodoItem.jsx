...
const TodoItem = (props) => {
    const { id, text, completed, markComplete, deleteTask, updateTask } = props
    ...
    return (
        <div className='flex flex-start px-2 py-3 items-center'>
            ...
            <div className='flex items-center space-x-4'>
                <button className='w-8 h-8 rounded-md flex items-center justify-center text-white bg-cyan-500 hover:bg-cyan-600'><MdModeEdit onClick={() => updateTask({ id, text, completed })} /></button>
